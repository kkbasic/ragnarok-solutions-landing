  ...
  const portfolioItems = [
    {
      title: "My IARE",
      description:
        "A Flutter-based app for campus management, streamlining student records, attendance, and results with real-time updates using Firebase.",
      category: "Mobile App Development",
      image: "/images/myIare.jpeg",
    },
    {
      title: "Geoprospector",
      description:
        "A software solution using Google Maps satellite images and machine learning to identify locations for renewable energy infrastructure.",
    ...
    },
    {
      title: "CMS Bot",
      description:
        "A Telegram bot designed for campus management, providing services and information to students, faculty, and staff.",
    ...
    },
    {
      title: "BiG App",
      description:
        "A Flutter-based app for gated communities, offering secure access control, visitor management, and resident communication.",
      category: "Mobile App Development",
        ...
        >
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Discover our latest projects showcasing innovative software
                solutions.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {portfolioItems.map((item, index) => (
                ...
                >
                  <div className="mb-6">
                    <div className="w-full h-48 bg-zinc-700 rounded-lg overflow-hidden">
                      <img
                        src={item.image}
                        alt={item.title}
